...
position_drive2(0, 87, 21, 120, 0, 80, 0.05, 0, 1800, 200, 40, false); // pick up rest of cubes
...
loader_right.move(127);
loader_left.move(127);
position_drive2(0, -10, -32, -10, 0, 100, 0.1, 0, 2500, 50, 40, false); // go forward and pick up cube
position_drive2(-32, -10, -20, -10, 0, -127, 0.1, 5, 2500, 50, 40, false); // go back
autoIntakeFunc(0);
sensor_outtake();
lift(2800, 20000);
pros::delay(1000);
position_drive2(-20, -10, -39, -10, 0, 127, 0.1, 5, 2500, 50, 40, false); // go forward and outtake
loader_right.move(-127);
loader_left.move(-127);
pros::delay(1000);
position_drive2(-39, -10, -20, -10, 0, -127, 0.1, 17, 2500, 50, 40, false); // go back
...
pros::delay(2000);
position_drive2(1.5, 113, 1.5, 100, 0, -127, 0.05, 5, 9000, 60, 40, false); // go back
autoIntakeFunc(0);
sensor_outtake();
lift(2800, 20000);
pros::delay(2000);
position_turn(90, 1000, 100); // turn to tower
position_drive2(1.5, 105, 8, 105, 0, 127, 0.05, 0, 1500, 200, 40, false); // go forward to tower
loader_right.move(-120);
loader_left.move(-120);
pros::delay(1500);
...
loader_right.move(127);
loader_left.move(127);
position_drive2(position.x, position.y, 34, 61, 0, 127, 0.05, 0, 20000, 200, 40, true); // go to stack zone
autoIntakeFunc(0);
sensor_outtake();
lift(2800, 20000);
pros::delay(1000);
...
//RED FRONT AUTO
  ...
  if(switcher == 2){
    ...
    position_drive2(25, 48, 25, 18, 0, -127, 0.1, 0, 2500, 50, 127, false); // go back
    autoIntakeFunc(0);
    position_turn(125, 1000, 110); // turn to stack
    position_drive2(25, 20, 34, 10, 0, 127, 0.05, 0, 900, 50, 80, false); // go back
    angler_pid(-4500, true, 127, true);
    pros::delay(2500);
...
//1 POINT UNLOCK AUTO RED RIGHT
  ...
  //BLUE BACK AUTO
    if(switcher == 6){
      ...
      autoIntakeFunc(127);
      pros::delay(800);
      position_drive2(0, 0, 0, 27, 0, 127, 0.1, 0, 1200, 50, 90, false);
      position_drive2(0, 20, 0, 25, 0, 50, 0.1, 0, 1000, 50, 90, false);
      // autoIntakeFunc(0);
      // loader_right.move(127);
      // loader_left.move(127); // wait till cube gets in tray fully
      ...
      // loader_left.move(0);
      autoIntakeFunc(0);
      position_drive2(0, 25, -30, 8, 0, -127, 0.1, 0, 1600, 40, 127, false); // go back
      position_turn(0, 500, 127);
      autoIntakeFunc(127);
      position_drive2(-25, 0, -25, 48, 0, 85, 0.05, 0, 2700, 50, 95, false); // pick up line of cubes
      position_drive2(-25, 48, -25, 17, 0, -127, 0.1, 0, 2500, 50, 127, false); // go back
      autoIntakeFunc(0);
      position_turn(-118, 1000, 110); // turn to stack
      loader_right.move(0);
      loader_left.move(0);
      position_drive2(-25, 20, -44, 4, 0, 127, 0.05, 0, 1100, 50, 80, false); // go back
      angler_pid(-4500, true, 127, true);
      pros::delay(2500);
      drive_line_up(-127, 700);
