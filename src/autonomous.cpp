...
//RED BACK AUTO
  if(switcher == 2){
    ...
    position_drive(22,5,0,false,110,3000);//strafe to the second set
    position_drive(22,45,0,false,100,3000);//pick up second set of cubes
    loader_left.move(0);
    loader_right.move(0);
    position_drive(20,5,90,true,110,3000);//come back facing the scoring zone
    position_drive(20,-10,90,false,100,500);//strafe to line up with wall
