...
void autonomous() {
  ...
  position_drive2(0, 45, -4, 55, 0, 127, 0.1, 0, 2500, 50, 40, false);
  loader_right.move(-80);
  loader_left.move(-80);
  pros::delay(1500);
  position_drive2(-4, 55, 0, 51, 0, -127, 0.1, 0, 2000, 50, 40, false);
  position_turn(0, 1000, 80);
  loader_right.move(0);
  loader_left.move(0);
  lift(0, 4000);
  pros::delay(1500);
  loader_right.move(127);
  loader_left.move(127);
  position_drive2(0, 48, 0, 117, 0, 70, 0.05, 0, 5000, 50, 40, false);
  pros::delay(1500);
  position_turn(55, 2000, 127);
  loader_left.move(0);
  loader_right.move(0);
  position_drive2(0, 117, 10, 127, 0, 100, 0.1, 0, 2500, 50, 40, false);
  angler_pid(-4550, true, 127, true);
  angler_pid(0, true, 127, false, 2000000);
  pros::delay(1300);
  ...
  loader_right.move(127);
  loader_left.move(127);
  position_drive2(0, -10, -25, -10, 0, 100, 0.1, 0, 2500, 50, 40, false);
  pros::delay(1000);
  loader_left.move(0);
  loader_right.move(0);
  lift(2500, 20000);
  pros::delay(1000);
  position_drive2(-24, -10, -34, -10, 0, 100, 0.1, 0, 2500, 50, 40, false);
  loader_right.move(-80);
  loader_left.move(-80);
