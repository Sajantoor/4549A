...
void autonomous() {
  ...
  // loader_left.move(127);
  // loader_right.move(127);
  // position_drive2(0, 0, 0, 10, 0, 90, 0.1, 0, 2000, 50, 40, false);
  // sensor_outtake();
  // lift(2500, 20000);
  // position_drive2(0, 10, 0, 28, 0, 60, 0.1, 0, 3000, 50, 40, false);
  // loader_left.move(-127);
  // loader_right.move(-127);
  // pros::delay(500);
  // loader_right.move(127);
...
loader_right.move(127);
loader_left.move(127);
position_drive2(0, 0, 0, 45, 0, 75, 0.05, 0, 20000, 50, 40, false);
pros::delay(1000);
sensor_outtake();
lift(2500, 20000);
pros::delay(1500);
position_turn(-20, 1500, 100);
// position_drive2(0, 45, -5, 55, 0, 127, 0.05, 0, 2500, 30, 40, false);
loader_right.move(-115);
loader_left.move(-115);
pros::delay(1500);
...
loader_left.move(0);
loader_right.move(0);
position_drive2(0, 117, 9, 122, 0, 100, 0.1, 0, 5000, 60, 40, false);
angler_pid(-4500, true, 127, false);
pros::delay(4000);
...
lift(2800, 20000);
pros::delay(2000);
position_drive2(-16, -10, -21, -10, 0, 100, 0.1, 0, 2500, 50, 40, false);
...
loader_right.move(127);
loader_left.move(127);
position_drive2(0, 0, 1.5, 118, 0, 60, 0.05, 0, 9000, 200, 40, false);
pros::delay(3000);
position_drive2(1.5, 118, 1.5, 105, 0, -127, 0.05, 0, 9000, 60, 40, false);
loader_left.move(0);
loader_right.move(0);
sensor_outtake();
lift(2800, 20000);
pros::delay(2000);
position_turn(90, 1000, 100);
position_drive2(0, 120, 6.5, 102, 0, 60, 0.05, 0, 7000, 200, 40, false);
loader_right.move(-90);
loader_left.move(-90);
position_drive2(6.5, 102, -21.8, 102, 0, -100, 0.05, 0, 7000, 200, 40, false);
position_turn(-51.9, 1000, 100);
position_drive2(-21.8, 102, -28.4, 116, 0, 100, 0.05, 0, 7000, 200, 40, false);
