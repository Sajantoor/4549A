...
pros::Motor loader_left(LOADER_LEFT, MOTOR_GEARSET_18, false, pros::E_MOTOR_ENCODER_COUNTS);
pros::Motor angler(ANGLER, MOTOR_GEARSET_18, false, pros::E_MOTOR_ENCODER_COUNTS);
